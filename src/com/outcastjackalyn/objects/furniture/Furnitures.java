...
public enum Furnitures {
    TABLE("table", "There is an #adj# wooden table.", "on the table", LockState.ALWAYS_OPEN),
    ...
    CHEST("chest", "You see a wooden box ... is that a treasure chest?" , "in the chest", LockState.LOCKED),
